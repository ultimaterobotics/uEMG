...
void ffti_f(complex_f data[], unsigned log2_N, int is_inverse)
{
    ffti_shuffle_f(data, log2_N);
    ffti_evaluate_f(data, log2_N, is_inverse);
}
...
void ffti_evaluate_f(complex_f data[], unsigned log2_N, int is_inverse)
{
    /*
    ...
    N = 1 << log2_N;
    theta_2pi = (is_inverse) ? M_PI : -M_PI;
    theta_2pi *= 2;
